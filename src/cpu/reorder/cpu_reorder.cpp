...
const static std::map<reorder_impl_key_t, const void *> &compression_s8s8_impl_list_map() {
    static  std::map<reorder_impl_key_t, const void *> the_map = {
...
const static std::map<reorder_impl_key_t, const void *> &conv_compression_s8s8_impl_list_map() {
     static  std::map<reorder_impl_key_t, const void *> the_map = {
